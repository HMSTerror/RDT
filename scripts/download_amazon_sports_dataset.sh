...
REVIEWS_GZ="${DATA_ROOT}/Sports_and_Outdoors_5.json.gz"
REVIEWS_JSON="${DATA_ROOT}/Sports_and_Outdoors_5.json"
META_GZ="${DATA_ROOT}/meta_Sports_and_Outdoors.json.gz"
META_JSON="${DATA_ROOT}/meta_Sports_and_Outdoors.json"
...
Notes:
  ...
  - If your server lacks CA certificates, you can temporarily use:
      INSECURE_SKIP_TLS_VERIFY=1 bash scripts/download_amazon_sports_dataset.sh
  - A safer option is:
      CA_BUNDLE=/path/to/cacert.pem bash scripts/download_amazon_sports_dataset.sh
EOF
