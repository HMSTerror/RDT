...
# imgaug is optional in this project. On newer NumPy versions (>=2.0),
# some imgaug releases are incompatible at import time.
try:
    np.bool = np.bool_
    import imgaug.augmenters as iaa
except Exception:  # pragma: no cover - best-effort compatibility fallback
    iaa = None
