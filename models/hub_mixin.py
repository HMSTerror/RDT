...
if is_torch_available():
    ...
    try:
        from safetensors.torch import save_file as save_safetensors_file  # type: ignore
...
class CompatiblePyTorchModelHubMixin(PyTorchModelHubMixin):
    ...
    def _save_pretrained(self, save_directory: Path) -> None:
        ...
        if save_safetensors_file is not None:
            ...
            save_safetensors_file(contiguous_state_dict, str(save_directory / SAFETENSORS_SINGLE_FILE))
            return

        # Fallback for environments without safetensors installed.
        torch.save(state_dict, str(save_directory / PYTORCH_WEIGHTS_NAME))
